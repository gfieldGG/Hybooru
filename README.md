...
| tags.ignore                  | string[]                  | `[]`                                                                      | List of tags that will not be imported from Hydrus (posts tagged by these tags will still be imported). Matched after sibling resolution.                                                                                                                                                        |
...
| tags.hiddenNamespaces        | string[]                  | `[]`                                              | Tag namespaces that are not shown in the post page sidebar. Tags in these namespaces are still imported and searchable.                                                                                                                                        |
